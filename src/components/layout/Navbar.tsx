        ...
        <div className="flex items-center justify-between h-12">
              ...
              {isAdmin && (
                <Link href="/admin"
                  className={clsx('px-3 py-1.5 rounded-md text-xs font-medium transition-colors',
                    pathname.startsWith('/admin') ? 'bg-red-50 text-red-700' : 'text-red-400 hover:text-red-600 hover:bg-red-50')}>
                  Admin
                </Link>
              )}
            </div>
          ...
          {session ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/login" className="px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-medium rounded-lg transition-colors">
                Register
              </Link>
            </div>
          )}
