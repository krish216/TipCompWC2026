...
// Aggregate only (no individual users), admin-only. Available any time (incl.
// before kickoff) so admins can prep content; users still can't see each other's
// picks until kickoff via the normal tipsheet reveal rule.
