...
export async function GET(request: NextRequest) {
  ...
  // Entrant = completed a bracket, i.e. picked a champion (the `final` slot — the
  // culmination of the bracket flow). Excludes abandoned/partial brackets.
  const userIds = Object.keys(byUser).filter(uid => !!byUser[uid]['final'])
