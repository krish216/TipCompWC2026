...
export async function GET(request: NextRequest) {
  ...
  const fields = 'id,tournament_id,round_code,round_name,round_order,tab_group,tab_label,month_key,month_label,is_knockout,predict_mode,result_pts,exact_bonus,margin_bonus,pen_bonus,fav_team_2x,fav_exact_bonus,include_in_scoring'
