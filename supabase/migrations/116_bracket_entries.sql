...
CREATE TABLE IF NOT EXISTS public.bracket_entries (
  ...
  final_goals   smallint,   -- tie-break 1: predicted total goals in the Final (full-time/ET, excl. penalty shootout)
  tp_goals      smallint,   -- tie-break 2: predicted total goals in the 3rd-place match (excl. penalty shootout)
  phone         text,
